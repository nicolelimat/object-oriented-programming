    ...
    public void exibirDetalhes(ArrayList<Cliente> clientes){
      ...
      for(int i = 0; i < clientes.size(); i++){
        ...
        for(int j = 0; j < cliente.getNumeroDeContas(); j++){
          String tipoConta = cliente.getConta(j) instanceof ContaPoupanca? "Conta Poupança" : "Conta Corrente";
          System.out.println("Tipo de conta: " + tipoConta + " com saldo de R$ " + cliente.getConta(j).getSaldo());
        }
        System.out.println();
      }
    }
